  ...
  return (
    ...
    >
      ...
      <div className="mb-3">
        ...
        {/* <select
          className="form-select w-50 mx-auto mb-3 w-full border-2 border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
        ...
        <Dropdown
          value={
            ...
            " " +
            allDoctors.data.filter((doctor) => doctor.id === formData.doctor)[0]
              ?.lastName
            : ""
          }
